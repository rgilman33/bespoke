...
class Autopilot():
    ...
    def step(self):
        ...
        ego_in_intx = any(self.is_left_turn[current_wp_ix:current_wp_ix+int(8/WP_SPACING)]) or \
                        any(self.is_right_turn[current_wp_ix:current_wp_ix+int(8/WP_SPACING)])
        ...
        # if ((self.overall_frame_counter+self.dagger_freq_offset) % self.DAGGER_FREQ == 0) and (self.current_speed_mps > DAGGER_MIN_SPEED) and not self.is_rando_yielding:
